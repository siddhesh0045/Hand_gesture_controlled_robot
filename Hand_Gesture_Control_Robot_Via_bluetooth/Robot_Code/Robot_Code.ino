...
#define in4 6 //Motor2  L298 Pin in2 
...
Serial.println(bt_data);          
     ...
     if(bt_data == 'f'){forword();  Speed=250;}  // if the bt_data is 'f' the DC motor will go forward
else if(bt_data == 'b'){backword(); Speed=250;}  // if the bt_data is 'b' the motor will Reverse
